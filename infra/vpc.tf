...
# パブリックサブネット x2（ALB・ECS Fargate 用、マルチ AZ）
...
resource "aws_subnet" "public_c" {
  ...
  tags = { Name = "${var.project_name}-public-subnet-c" }
}

# プライベートサブネット x2（RDS 用、マルチ AZ）
